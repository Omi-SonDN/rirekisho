...
<table class="imagetable">
    ...
    <tr>
        ...
        {{--</td>--}}
        <td style="width: 100%; padding: 0">
            <input onkeyup="isChanges(this.id, '{{$CV->hash}}')" class="col-md-12 textarea" style="padding: 5px; 0px" id="textarea_ceo_{{$CV->hash}}" type="text" value="{{($CV->user_gioi_thieu) ? $CV->user_gioi_thieu : '' }}" />
        </td>
    </tr>
    <tr>
        <td style="width: 100%; padding: 0">
