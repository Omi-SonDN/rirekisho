            ...
            @can('Admin')
                <td>
                    <div class="status" id="status{{ $CV->id }}">
                        ...
                        <button id="btn_send_email{{ $CV->id }}" class="btn btn-primary btn-send-email"
                                value="{{ $CV->Status }}">Send Email {{ $CV->Status }}</button>
                    </div>
                </td>
                <td>
                    <button style="margin-left: 25px;" class="btn btn-default btn-edit"><a
                                href="{{url('CV',[$CV ,'edit'])}}"><span class="glyphicon glyphicon-edit"
