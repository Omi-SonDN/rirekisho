            ...
            <table class="table table-hover table-responsive" id="groups-list">
                ...
                @foreach($groups as $group)
                    <tr id="group{{ $group->id }}" tabindex="-1">
                        ...
                        <td>
                            <button class="btn btn-info btn-lg group_info" name="btn_group_info" id="btn_group_info"
                                    value="{{ $group->id }}">Show group's members
                            </button>
                        </td>
                        <td>
                            <button class="btn btn-warning btn-lg open-modal" name="btn_group" id="btn_group"
                                    value="{{ $group->id }}">Edit
                            </button>
                            <button class="btn btn-danger btn-lg delete-group" name="btn_delete" id="btn_delete"
                                    value="{{ $group->id }}">Delete
                            </button>
                        </td>
                    </tr>
                @endforeach
