webshims.register("mediaelement-native-fix", function (a, b, c, d) {
    var e = b.support, f = function () {
        ...
        var c = function (a) {
            ...
            if (d = d.originalEvent, d && "lengthComputable" in d) {
                var e = b.data(d.target, "mediaelement");
                if ((!e || "html5" == e.isActive) && d.lengthComputable && "loaded" in d) {
                    var f = d.target.duration, g = c(d.target);
                    g.loaded = f ? d.loaded / d.total * f : 0, g.loaded && (g.buffered.length = 1), "load" == d.type && a(d.target).triggerHandler("progress")
                }
            }
        }, f = function (a) {
            var b = c(a.target);
        ...
        return e.mediaDefaultMuted ? a.noop : function () {
            if (!a.data(this, "fixedMediaProgress")) {
                var d, e, f = this, g = function () {
                    ...
                    if (b) {
                        for (var c = "", d = 0, e = b.length; e > d; d++)c += b.end(d);
                        return c
                    }
                }, h = function () {
                    var c = g();
                ...
                a(this).data("fixedMediaProgress", !0).on({
                    "play loadstart progress": function (a) {
                        "progress" == a.type && (e = g(this)), clearTimeout(d), d = setTimeout(h, 800)
                    }, "emptied stalled mediaerror abort suspend": function (a) {
