!function (a) {
    ...
    "use strict";
    var g, h, i, j = 'input[type="file"].ws-filereader, input[type="file"].ws-capture', k = swfmini.hasFlashPlayerVersion("10.3"), l = function () {
    ...
    }), s = b.cfg.basePath + "moxie/", t = 'You nedd a crossdomain.xml to get all "filereader" / "XHR2" / "CORS" features to work. Or host moxie.swf on your server an configure filereader options: "swfpath"', u = function (b) {
            ...
            return b.info("moxie transfer used for $.ajax"), "no" == i && b.error(t), {
                send: function (b, e) {
                        ...
                        if (c[b]) {
                            ...
                            d.addEventListener("load", function () {
                                e ? e.lengthComputable && e.total > e.loaded && c[b]({
                                    ...
                                    total: e.total,
                                    loaded: e.total
                                }) : c[b]({type: "progress", lengthComputable: !0, total: 1, loaded: 1})
                    ...
                    d = new h.xhr.XMLHttpRequest, d.open(c.type, c.url, c.async, c.username, c.password), g(d.upload, f.uploadprogress), g(d.upload, f.progress), d.addEventListener("load", function () {
                        var a = {text: d.responseText, xml: d.responseXML};
        ...
        xdomain: function () {
            var c = /^https?:\/\//i, d = /^get|post$/i, e = new RegExp("^" + location.protocol, "i");
            return function (f, h) {
                    ...
                    return b.info("xdomain transport used."), {
                        send: function (b, c) {
                            ...
                            i = new XDomainRequest, /^\d+$/.test(h.timeout) && (i.timeout = h.timeout), i.ontimeout = function () {
                                ...
                                c(500, "error", {text: i.responseText})
    ...
    b.loader.addModule("moxie", {src: "moxie/js/moxie-" + (k ? "swf" : "html4")}), f.progress || (f.progress = "onprogress"), f.uploadprogress || (f.uploadprogress = "onuploadprogress"), f.swfpath || (f.swfpath = s + "flash/Moxie.min.swf"), a.support.cors === !1 && c.XDomainRequest || delete w.xdomain, a.ajaxTransport("+*", function (a, b, c) {
        var d, e;
        if ((a.wsType || w[w]) && (d = w[w](a, b, c)), !d)for (e in w)if (d = w[e](a, b, c))break;
        return d
    }), b.defineNodeNameProperty("input", "files", {
        prop: {
            writeable: !1, get: function () {
            ...
            value: function (c, d, e) {
                ...
                d || (d = "image/jpeg"), "image/jpeg" != d || e || (e = .8), l(), b.ready("moxie", function () {
                    ...
                    f = h.callProp("getAsDataURL", [d, e]), a.onload = function () {
                        var d = a.getAsBlob();
                        b.defineProperty(d, "_wsDataURL", {value: f, enumerable: !1}), c(d)
                    }, a.load(f)
                })
            }
        }
    }), b.ready("url", function () {
        var a = URL.createObjectURL, b = URL.revokeObjectURL;
        ...
        h = c.moxie, g = c.mOxie, g.Env.swf_url = f.swfpath, c.FileReader = g.FileReader, c.FormData = function (c) {
            ...
            if (c && a.nodeName(c, "form")) {
                ...
                for (d = c.querySelectorAll('input[type="file"][name]'), e = 0, f = d.length; e < d.length; e++)if (k = d[e].name, k && !a(d[e]).is(":disabled") && (h = a.prop(d[e], "files") || [], h.length))for ((h.length > 1 || l.hasBlob && l.hasBlob()) && b.error("FormData shim can only handle one file per ajax. Use multiple ajax request. One per file."), i = 0, j = h.length; j > i; i++)l.append(k, h[i])
            }
            return l
        ...
        if (c(), null == i)try {
            a.ajax({
                url: "crossdomain.xml", type: "HEAD", dataType: "xml", success: function () {
                    i = "yes"
                }, error: function () {
                    i = "no"
                }, complete: function () {
    ...
    "use strict";
    var g = b.mediaelement, h = c.swfmini, i = b.support, j = i.mediaelement, k = h.hasFlashPlayerVersion("11.3"), l = 0, m = "ActiveXObject" in c && j, n = {
        paused: !0,
        ended: !1,
        currentSrc: "",
        duration: c.NaN,
    ...
    }, o = Object.keys(n), p = {currentTime: 0, volume: 1, muted: !1}, q = (Object.keys(p), a.extend({
        isActive: "html5",
        activating: "html5",
        wasSwfReady: !1,
        _usermedia: null,
    ...
    b.extendUNDEFProp(f.params, {
        ...
        controltype: "1",
        jsapi: "1"
    }), b.extendUNDEFProp(f.attrs, {bgcolor: "#000000"}), f.playerPath = t;
    var u = function (a, b) {
    ...
    var w, x = {
        onPlayPause: function (a, b, c) {
            ...
            return function (d, e) {
                var f = 0, g = function () {
                    return f > 9 ? void(e.tryedReframeing = 0) : (f++, e.tryedReframeing++, void(c(e) ? (e.wasSwfReady = !0, e.tryedReframeing = 0, z(e), y(e)) : e.tryedReframeing < 6 ? e.tryedReframeing < 3 ? (e.reframeTimer = setTimeout(g, 9), e.shadowElem.css({overflow: "visible"}), setTimeout(function () {
                        e.shadowElem.css({overflow: "hidden"})
                    }, 1)) : (e.shadowElem.css({overflow: "hidden"}), a(e._elem).mediaLoad()) : (clearTimeout(e.reframeTimer), b.error("reframing error"))))
                };
    ...
    var y = function (a) {
        var c, d = a.actionQueue.length, e = 0;
    ...
    if (j) {
        var B = {
            play: 1,
            playing: 1
        }, C = ["play", "pause", "playing", "loadstart", "canplay", "progress", "waiting", "ended", "loadedmetadata", "durationchange", "emptied"], D = C.map(function (a) {
    ...
    var F = function () {
        var a = ["_calledMeta", "lastDuration", "_bufferedEnd", "lastCalledTime", "_usermedia", "_bufferedStart", "_ppFlag", "currentSrc", "currentTime", "duration", "ended", "networkState", "paused", "seeking", "videoHeight", "videoWidth"], b = a.length;
        return function (c) {
            if (c) {
                clearTimeout(c._seekedTimer);
                var d = b, e = c.networkState;
        ...
        var e = {}, f = function (b) {
        ...
        }, h = ["minWidth", "maxWidth", "minHeight", "maxHeight"], i = function (a, b) {
            var c, d, e = !1;
            ...
            }, k = {width: !j.width && a(h).width(), height: !j.height && a(h).height()};
    ...
    }(), J = {A: /&amp;/g, a: /&/g, e: /\=/g, q: /\?/g}, K = function (a) {
    ...
    g.resetSwfProps = F, g.createSWF = function (c, e, f) {
        ...
        var i, m = e.streamrequest, n = "jarisplayer/stream" == e.type, o = a.prop(c, "controls"), p = "jarisplayer-" + b.getID(c), r = c.nodeName.toLowerCase(), t = function () {
        ...
        return n && !m ? void webshim.usermedia.attach(c, e, f) : (f && f.swfCreated ? (g.setActive(c, "third", f), f.currentSrc = "", f.shadowElem.html('<div id="' + p + '">'), f.api = !1, f.actionQueue = [], i = f.shadowElem, F(f), f.currentSrc = e.srcProp) : (a(d.getElementById("wrapper-" + p)).remove(), i = a('<div class="polyfill-' + r + " polyfill-mediaelement " + b.shadowClass + '" id="wrapper-' + p + '"><div id="' + p + '"></div>').css({
            ...
            actionQueue: {value: []},
            shadowElem: {value: i},
            _elemNodeName: {value: r},
            _elem: {value: c},
            currentSrc: {value: m ? "" : e.srcProp},
            swfCreated: {value: !0},
            id: {value: p.replace(/-/g, "")},
            buffered: {
                value: {
                    start: function (a) {
    ...
    var N = function (c, d, e, g, i, j) {
        var k, l, m, n, o = "audio/rtmp" == d.type || "video/rtmp" == d.type, p = "jarisplayer/stream" == d.type;
        k = a.extend({}, f.vars, {
    ...
    var P = function () {
        ...
        var e = CanvasRenderingContext2D.prototype.drawImage, g = Array.prototype.slice, h = {
            video: 1,
            VIDEO: 1
        }, i = {}, j = function () {
            var b = webshim.defineNodeNameProperty("canvas", "toBlob", {
                prop: {
                    value: function () {
                        var c = a(this).callProp("getContext", ["2d"]), d = this, e = arguments, f = function () {
        ...
        return e || webshim.error("canvas.drawImage feature is needed. In IE8 flashvanvas pro can be used"), CanvasRenderingContext2D.prototype.wsImageComplete = function (a) {
            ...
            if (h[a.nodeName] && (c = b.data(a, "mediaelement")) && "third" == c.isActive && c.api.api_image) {
                ...
                return i[c.currentSrc] || (i[c.currentSrc] = !0, null == l && b.error("video has to be same origin or a crossdomain.xml has to be provided. Video has to be visible for flash API")), k = g.call(arguments, 1), f.canvasSync && c.canvasImg && (k.unshift(c.canvasImg), e.apply(n, k), k = g.call(arguments, 1), m = !0), j = d.createElement("img"), j.onload = function () {
                    if (k.unshift(this), j.onload = null, !(f.canvasSync && (c.canvasImg = j, m && f.noDoubbleDraw)) && (e.apply(n, k), n._wsIsLoading = !1, n._wsLoadingCbs && n._wsLoadingCbs.length))for (; n._wsLoadingCbs.length;)n._wsLoadingCbs.shift().call(n, n)
    ...
    if (P() || b.ready("canvas", P), k && a.cleanData) {
        var Q = a.cleanData, R = d.createElement("object"), S = {
            SetVariable: 1,
            GetVariable: 1,
            SetReturnValue: 1,
            GetReturnValue: 1
        ...
        a.cleanData = function (a) {
            ...
            if (a && (c = a.length) && l)for (b = 0; c > b; b++)if (T[a[b].nodeName] && "api_destroy" in a[b]) {
                l--;
                try {
                    if (a[b].api_destroy(), 4 == a[b].readyState)for (d in a[b])S[d] || R[d] || "function" != typeof a[b][d] || (a[b][d] = null)
                } catch (f) {
                    console.log(f)
                }
            }
