!function (a) {
    ...
    if (!b.defineProperties) {
        var c = "defineProperty", d = Object.prototype.hasOwnProperty, e = ["configurable", "enumerable", "writable"], f = function (a) {
            for (var b = 0; 3 > b; b++)void 0 !== a[e[b]] || "writable" === e[b] && void 0 === a.value || (a[e[b]] = !0)
        }, g = function (a) {
            if (a)for (var b in a)d.call(a, b) && f(a[b])
        };
    ...
    var g = !("hrefNormalized" in a.support) || a.support.hrefNormalized, h = Object.prototype.hasOwnProperty;
    ...
    var j = /\s*,\s*/, k = {}, l = {}, m = {}, n = {}, o = {}, p = {}, q = a.fn.val, r = function (b, c, d, e, f) {
    ...
    var s = 0, t = "_webshims" + Math.round(1e3 * Math.random()), u = function (b, c, d) {
    ...
    [{name: "getNativeElement", prop: "nativeElement"}, {
        ...
        prop: "shadowElement"
    }, {name: "getShadowFocusElement", prop: "shadowFocusElement"}].forEach(function (b) {
        a.fn[b.name] = function () {
            var c = [];
            return this.each(function () {
                var d = u(this, "shadowData"), e = d && d[b.prop] || this;
        ...
        a.event.trigger = function (c, d, e, f) {
            ...
            var g, i, j, k = e[c], l = a.prop(e, c), n = l && k != l;
        ...
        k[c] = a[c], a[c] = function (b, d, f, g, h) {
            var i = "val" == g, j = i ? r : k[c];
            if (!b || !l[d] || 1 !== b.nodeType || !i && g && "attr" == c && a.attrFn[d])return j(b, d, f, g, h);
            var m, o, q, s = (b.nodeName || "").toLowerCase(), t = n[s], u = "attr" != c || f !== !1 && null !== f ? c : "removeAttr";
            ...
            n[a] || (n[a] = {}), n[a][d] || (n[a][d] = {});
            var g = n[a][d][c], h = function (a, b, e) {
                var g;
    ...
    var v = function () {
        var a = b.getPrototypeOf(d.createElement("foobar")), c = b.support.advancedObjectProperties && b.support.objectAccessor;
    ...
    a.extend(b, {
        xProps: l, getID: function () {
        ...
        }(), domPrefixes: ["webkit", "moz", "ms", "o", "ws"], prefixed: function (a, c) {
            var d, e, f = !1;
            if (c[a] && (f = a), !f)for (a = a.charAt(0).toUpperCase() + a.slice(1), d = 0; d < b.domPrefixes.length; d++)if (e = b.domPrefixes[d] + a, e in c) {
                f = e;
                break
            }
            return f
        }, shadowClass: "wsshadow-" + Date.now(), implement: function (c, d) {
            ...
            var c = /\-([a-z])/g, d = {}, e = {}, f = function (a, b) {
            ...
            var e, f, g, h = a(c), i = {
                init: !1, runs: 0, test: function () {
                    var a = i.getHeight(), b = i.getWidth();
                    a != i.height || b != i.width ? (i.height = a, i.width = b, i.handler({type: "docresize"}), i.runs++, i.runs < 9 && setTimeout(i.test, 90)) : i.runs = 0
                }, handler: function () {
                    var b, j = function () {
                        a(d).triggerHandler("updateshadowdom", [b])
                    }, k = function () {
                        if (b && "resize" == b.type) {
                            var a = h.width(), d = h.width();
                            if (d == f && a == g)return;
                            f = d, g = a
                        }
                    ...
                    a.each({Height: "getHeight", Width: "getWidth"}, function (a, b) {
                        var c = d.body, e = d.documentElement;
                        i[b] = function () {
            ...
            return b.docObserve = function () {
                ...
                if (c && d) {
                    ...
                    var f = a.data(c, t) || a.data(c, t, {}), g = a.data(d, t) || a.data(d, t, {}), h = {};
            ...
            return l[d] = !0, e.reflect && (e.propType && !b.propTypes[e.propType] ? b.error("could not finde propType " + e.propType) : b.propTypes[e.propType || "standard"](e, d)), ["prop", "attr", "removeAttr"].forEach(function (f) {
                var g = e[f];
                g && (g = "prop" === f ? a.extend({writeable: !0}, g) : a.extend({}, g, {writeable: !0}), o[f](c, d, g), "*" != c && b.cfg.extendNative && "prop" == f && g.value && a.isFunction(g.value) && v(c, d, g), e[f] = g)
            ...
            var f;
            return a.isFunction(d) && (d = {after: d}), w.createTmpCache(c), d.before && w.createElement(c, d.before), e && (f = b.defineNodeNameProperties(c, e, !1, !0)), d.after && w.createElement(c, d.after), w.flushTmpCache(), f
            ...
            var c = [], d = [], e = {}, f = function (d, f, h) {
                ...
                var d = b.__active, e = function (a, d) {
            ...
            return function (a) {
                var b;
                if ("string" == typeof a)c[0] != a && (c = [a], b = c[0].split("-")[0], b && b != a && c.push(b), d.forEach(g)); else if ("object" == typeof a)return a.__active || (d.push(a), g(a)), a.__active;
                return c[0]
            }
        }()
    }), a.each({
        ...
        if (!("content" in d.createElement("template") || (a(function () {
            ...
            a.webshims.addReady(function (b, f) {
                if (a.each(c, function (c, d) {
                    ...
                    var g = d.getElementsByTagName("header")[0], h = d.getElementsByTagName("footer"), i = h.length;
    ...
    var b = function (a) {
    ...
    }, d = ["step", "min", "max", "readonly", "title", "disabled", "tabindex"], e = function () {
        var a = {touchstart: 1, touchend: 1, touchmove: 1}, b = ["pageX", "pageY"];
        return function (c) {
            if (a[c.type] && c.originalEvent && c.originalEvent.touches && c.originalEvent.touches.length)for (var d = 0; d < b.length; d++)c[b[d]] = c.originalEvent.touches[0][b[d]];
            return c
        }
    }(), f = {
        _create: function () {
            var b;
            for (this.element.addClass(this.options.baseClass || "ws-range ws-input").attr({role: "slider"}).append('<span class="ws-range-rail ws-range-track"><span class="ws-range-min ws-range-progress" /><span class="ws-range-thumb"><span><span data-value="" data-valuetext="" /></span></span></span>'), this.trail = a(".ws-range-track", this.element), this.range = a(".ws-range-progress", this.element), this.thumb = a(".ws-range-thumb", this.trail), this.thumbValue = a("span[data-value]", this.thumb), this.updateMetrics(), this.orig = this.options.orig, b = 0; b < d.length; b++)this[d[b]](this.options[d[b]]);
        ...
        }, value: a.noop, _value: function (b, c, d) {
            var e, f, g = this.options, h = b, i = {}, j = {};
            ...
            var b = this.options, c = b.textValue ? b.textValue(this.options.value) : b.options[b.value] || b.value;
            ...
            var c = this.options, d = c.min, e = c.max, f = this.trail, g = this;
            this.element.attr({"aria-valuetext": c.options[c.value] || c.value}), a(".ws-range-ticks", f).remove(), a(this.orig).jProp("list").find("option:not([disabled])").each(function () {
                c.options[a.prop(this, "value")] = a.prop(this, "label") || ""
            }), a.each(c.options, function (h, i) {
                if (!(!b(h) || d > h || h > e)) {
                    var j = 100 * ((h - d) / (e - d)), k = 'data-value="' + h + '"';
            ...
            a = !!a, this.options.disabled = a, this.element.attr(a ? {
                tabindex: -1,
                "aria-disabled": "true"
            } : {tabindex: this.options.tabindex, "aria-disabled": "false"}), this._init && this.updateMetrics()
        }, tabindex: function (a) {
            this.options.tabindex = a, this.options.disabled || this.element.attr({tabindex: a})
        }, title: function (a) {
            ...
            var b = this.options, d = "any" == a ? "any" : c(a, 1);
            ...
            var b, c, d, f, g = this, h = this.options, i = function () {
                var b = {};
                return {
                    init: function (c, d, e) {
                        b[c] || (b[c] = {fn: e}, g.orig && a(g.orig).on(c, function () {
                ...
                if (!f && ("touchstart" != d.type || d.originalEvent && d.originalEvent.touches && 1 == d.originalEvent.touches.length) && (d.preventDefault(), a(document).off("mousemove touchmove", k).off("mouseup touchend", l), a(window).off("blur", m), !h.readonly && !h.disabled)) {
                    ...
                    b = b[g.dirs.pos], c = 100 / c, "ws-range-ticks" == d.target.className ? j(d.target.getAttribute("data-value"), h.animate) : k(d, h.animate), f = !0, a(document).on("touchstart" == d.type ? {
                        touchend: l,
                        touchmove: k
                    } : {mouseup: l, mousemove: k}), a(window).on("blur", m), d.stopPropagation()
                }
            }, o = {
                "touchstart mousedown": n, focus: function () {
            ...
            }, this.element.on(o), this.thumb.on({mousedown: n}), this.orig && a(this.orig).jProp("form").on("reset", function () {
    ...
    a.fn.rangeUI = function (b) {
        return b = a.extend({
            ...
            var c = a.extend(g(f), {element: a(this)});
    ...
    "use strict";
    var g, h = b.formcfg, i = b.support.formvalidation && !b.bugs.bustedValidity, j = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"], k = function (a) {
    ...
    }, p = !b.support.inputtypes.tel || -1 == navigator.userAgent.indexOf("Mobile") || "inputMode" in d.createElement("input") && !("inputmode" in d.createElement("input")) ? "text" : "tel", q = {
        date: {
            _create: function (b) {
                var c = {splits: []};
                ...
                n("d");
                var c = 0, d = a(".ws-input-seperator", b).html(g.dFormat), e = a("input, select", b);
            ...
            _create: function (b) {
                ...
                if (c.splits.push(b.yearSelect ? a('<select class="yy"></select>')[0] : a('<input type="' + p + '" class="yy" size="4" inputmode="numeric" maxlength="4" />')[0]), b.monthSelect)c.splits.push(a('<select class="mm">' + l(b) + "</select>")[0]); else if (c.splits.push(a('<input type="text" class="mm ws-spin" />')[0]), b.onlyMonthDigits) {
                    a().attr({inputmode: "numeric", size: 2, maxlength: 2});
                    try {
                ...
                var c, d = a(".ws-input-seperator", b).html(g.dFormat), e = a("input.mm, select.mm", b);
    ...
    var t = {
        number: {step: 1},
        "datetime-local": {step: 60, start: new Date(r).getTime()},
        time: {step: 60},
        month: {step: 1, start: new Date(r)},
        date: {step: 1, start: new Date(r)}
    }, u = function () {
        var c = function () {
            return b.getID(this)
        };
        return function (b, d, e) {
            a(b).attr({"aria-labelledby": d.map(c).get().join(" ")}), e || d.on("click", function (a) {
    ...
    f.addZero = v, b.loader.addModule("forms-picker", {
        ...
        var c = function (a, b) {
            ...
            number: function (a) {
                ...
                var d = "monthNamesShort" == b.monthNames ? /[\s-\/\\]+/ : /[\.\s-\/\\]+/, e = b.splitInput ? a : a.trim().split(d);
        ...
        var j = {
            _create: function () {
                var b, c, d, e = this.options, f = this.createOpts;
                ...
                "color" == this.type && this.inputElements.prop("maxLength", 7), this.addBindings(), a(this.element).data("wsWidget" + e.type, this), e.buttonOnly && this.inputElements.prop({readOnly: !0}), this._init = !0, e.mirrorValidity && (c = this, d = function () {
            ...
            required: function (a, b) {
                this.inputElements.attr({"aria-required": "" + b}), this.mirrorValidity()
            },
        ...
        ["defaultValue", "value"].forEach(function (a) {
            ...
            j[b] = function (d, e) {
                var f = this.options;
                f[b] == e && this._init || (f[b] = !!e, !c && f.buttonOnly ? this.inputElements.attr({"aria-readonly": f[b]}) : this.inputElements.prop(b, f[b]), this.buttonWrapper[f[b] ? "addClass" : "removeClass"]("ws-" + b), c && a("button", this.buttonWrapper).prop("disabled", f[b]))
            }
        });
        var k = a.extend({}, j, {
            _create: function () {
                var c = this.options, d = h(c.type);
        ...
        }), a.each({min: 1, max: -1}, function (a, b) {
            var c = a + "AsNumber";
            k[a] = function (d) {
                this.elemHelper.prop(a, d), this[c] = this.asNumber(d), null != this.valueAsNumber && (isNaN(this.valueAsNumber) || !isNaN(this[c]) && this.valueAsNumber * b < this[c] * b) && this._setStartInRange(), this.options[a] = d, this._init && o({elements: this.inputElements}, this.options), this._propertyChange(a), this.mirrorValidity()
            }
        }), a.fn.wsBaseWidget = function (c) {
            return c = a.extend({}, c), this.each(function () {
                b.objectCreate(j, {element: {value: a(this)}}, c)
            })
        }, a.fn.wsBaseWidget.wsProto = j, a.fn.spinbtnUI = function (c) {
            return c = a.extend({monthNames: "monthNamesShort"}, c), this.each(function () {
                b.objectCreate(k, {element: {value: a(this)}}, c)
            })
        }, a.fn.spinbtnUI.wsProto = k, b._format = d
    }(), a.fn.wsTouchClick || (a.fn.wsTouchClick = function () {
        var b = "touchAction" in d.documentElement.style, e = !b && "ontouchstart" in c && d.addEventListener;
        return function (c, d) {
        ...
        var e = {}, f = c.Modernizr, g = f && (f.touchevents || f.touch) || /android|iphone|ipad|ipod|blackberry|iemobile/i.test(navigator.userAgent.toLowerCase());
        b.inlinePopover = {
            _create: function () {
            ...
            }, show: a.noop, hide: a.noop, preventBlur: a.noop, isVisible: !0
        }, e.isInRange = function (a, b, c) {
            return !(c[0] && c[0] > a[0] || b[0] && b[0] < a[0])
        }, e.createYearSelect = function (a, b, c, d, f) {
            f || (f = {start: a, step: 1, label: a});
            var g, h = !0, i = !0, j = ['<option selected="">' + f.label + "</option>"], k = 0, l = function (a, g) {
                var h, i;
            ...
            if (!c.options.nopicker) {
                var d = c.options, f = b.objectCreate(d.inlinePicker ? b.inlinePopover : b.wsPopover, {}, a.extend(d.popover || {}, {prepareFor: d.inlinePicker ? c.buttonWrapper : c.element})), g = a('<button type="button" class="ws-popover-opener"><span /></button>').appendTo(c.buttonWrapper), h = function () {
                ...
                d.containerElements.push(f.element[0]), f.element.addClass(c.type + "-popover input-picker").attr({role: "application"}).on({
                ...
                }), u(f.element.children("div.ws-po-outerbox").attr({role: "group"}), d.labels, !0), u(g, d.labels, !0), null != d.tabindex && g.attr({tabindex: d.tabindex}), d.disabled && g.prop({disabled: !0}), g.wsTouchClick(l), d.inlinePicker ? f.openedByFocus = !0 : (g.on({
                    mousedown: function () {
            ...
            var c = e._common.apply(this, arguments), d = a(b.orig).data("alphacontrol"), f = b.opener.prepend('<span class="ws-color-indicator-bg"><span class="ws-color-indicator" /></span>').find(".ws-color-indicator"), g = function () {
                f.css({backgroundColor: a.prop(this, "value") || "#000000"})
            }, h = function () {
                var a, c = function () {
                    try {
                        var a = b.alpha.prop("valueAsNumber") / (b.alpha.prop("max") || 1);
                        isNaN(a) || f.css({opacity: a})
                    } catch (c) {
                    }
                };
                return function (b) {
        ...
        var c, e, g = b.support.inputtypes, j = {}, l = {
            disabled: 1,
            required: 1,
            readonly: 1
        }, m = ["disabled", "readonly", "value", "defaultValue", "min", "max", "step", "title", "required", "placeholder"], n = ["data-placeholder", "tabindex"];
        ...
        var p = function () {
            ...
            var c, d, e, f, g, h, i, j = b.orig.style, k = b.element[0].style;
            ...
            if (j[v] && b.implement(this, "inputwidgets") && (!g[v] || !a(this).hasClass("ws-noreplace"))) {
                ...
                h.formatMonthNames && b.error("formatMonthNames was renamded to monthNames"), h.onlyMonthDigits && (h.monthNames = "monthDigits"), l.shim = j[v]._create(h), b.addShadowDom(this, l.shim.element, {data: l.shim || {}}), l.shim.options.containerElements.push(l.shim.element[0]), q = a.prop(this, "className"), h.classes && (q += " " + h.classes, a(this).addClass(h.classes)), (h.splitInput || "range" == v) && (q = q.replace("form-control", "")), l.shim.element.on("change input", k).addClass(q + " " + b.shadowClass), l.shim.buttonWrapper && (l.shim.buttonWrapper.addClass("input-button-size-" + l.shim.buttonWrapper.children().filter(r).length + " " + b.shadowClass), l.shim.buttonWrapper.filter(r).length && l.shim.element.addClass("has-input-buttons")), u(a(this).getShadowFocusElement(), p), a(this).on("change", function () {
                    ...
                    var b, c = {focusin: !0, focus: !0}, d = !1, e = !1;
        ...
        f.replaceUI && a.each(a.extend(w, a.isPlainObject(f.replaceUI) ? f.replaceUI : {
            ...
            w[c] === !1 || g[c] && !w[c] || p(c, {
                _create: function (d) {
                    ...
                    var e = d.splitInput ? '<span class="ws-' + c + ' ws-input ws-inputreplace" role="group"></span>' : '<input class="ws-' + c + ' ws-inputreplace" type="text" />', f = a(e).insertAfter(d.orig);
        ...
        null == a("<input />").prop("labels") && b.defineNodeNamesProperty("button, input, keygen, meter, output, progress, select, textarea", "labels", {
            prop: {
                get: function () {
                    ...
                    var b = this.id, c = a(this).closest("label").filter(function () {
