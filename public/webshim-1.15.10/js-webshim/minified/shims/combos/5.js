webshims.register("form-native-extend", function (a, b, c, d) {
    ...
    if (e.formvalidation && !b.bugs.bustedValidity) {
        var f = b.inputTypes, g = !1, h = {}, i = function () {
            var b, c = function () {
        ...
        b.addInputType = function (c, d) {
            ...
            h[a] = b
        }, a.each({typeMismatch: "mismatch", badInput: "bad"}, function (a, c) {
        ...
        var j = b.modules["form-number-date-api"], k = j.loaded && !j.test(), l = ["customError", "badInput", "typeMismatch", "rangeUnderflow", "rangeOverflow", "stepMismatch", "tooLong", "tooShort", "patternMismatch", "valueMissing", "valid"], m = ["value"], n = [], o = function (b) {
            if (b || g) {
            ...
            if (n.forEach(function (c) {
                    var d = b.defineNodeNameProperty(c, "validity", {
                        prop: {
                            get: function () {
                                if (!q) {
                                    var e = "input" == c ? a(this).getNativeElement()[0] : this, g = d.prop._supget.call(e);
                                    if (!g)return g;
                                    var i = {};
                                    ...
                                    }, n = k.val(), o = !!b.data(e, "hasCustomError");
        ...
        b.defineNodeNameProperty("input", "type", {
            prop: {
                get: function () {
                    var a = this, c = (a.getAttribute && a.getAttribute("type") || "").toLowerCase();
    ...
    var c = parseInt("NaN", 10), d = b.inputTypes, e = function (a) {
        ...
        return a && !isNaN(1 * a)
    }, i = b.addMinMaxNumberToCache, j = function (a, b) {
        a = "" + a, b -= a.length;
        for (var c = 0; b > c; c++)a = "0" + a;
        return a
    }, k = 1e-7, l = b.bugs.bustedValidity;
    ...
    var m = b.defineNodeNameProperty("input", "valueAsNumber", {
        prop: {
            get: function () {
                var b = this, e = g(b), f = d[e] && d[e].asNumber ? d[e].asNumber(a.prop(b, "value")) : m.prop._supget && m.prop._supget.apply(b, arguments);
                return null == f && (f = c), f
            }, set: function (c) {
                var e = this, f = g(e);
    ...
    a.each({stepUp: 1, stepDown: -1}, function (c, e) {
        var f = b.defineNodeNameProperty("input", c, {
            prop: {
                value: function (c) {
                    ...
                    if (m = {type: p}, c || (c = 1, b.warn("you should always use a factor for stepUp/stepDown")), c *= e, h = b.getStep(this, p), "any" == h)throw b.info("step is 'any' can't apply stepUp/stepDown"), "invalid state error";
    ...
    var o = {
        number: {
            bad: function (a) {
                return !e(a)
            }, step: 1, stepScaleFactor: 1, asNumber: function (a) {
                return e(a) ? 1 * a : c
            }, numberToString: function (a) {
                return e(a) ? a : !1
            }
        }, range: {minDefault: 0, maxDefault: 100}, color: {
            bad: function () {
                var a = /^\u0023[a-f0-9]{6}$/;
                return function (b) {
            ...
            bad: function (a) {
                ...
                var d = !1;
                if (c[0].length < 4 || 2 != c[1].length || c[1] > 12 || 2 != c[2].length || c[2] > 33)d = !0; else for (b = 0; 3 > b; b++)if (!h(c[b])) {
                    d = !0;
                    break
                }
                return d || a !== this.dateToString(this.asDate(a, !0))
            }, step: 1, stepScaleFactor: 864e5, asDate: function (a, b) {
            ...
            bad: function (b, c) {
            ...
            }, step: 60, stepBase: 0, stepScaleFactor: 1e3, asDate: function (a) {
                ...
                if (a && a.getUTCHours) {
                    var b = j(a.getUTCHours(), 2) + ":" + j(a.getUTCMinutes(), 2), c = a.getSeconds();
            ...
            }, step: 1, stepScaleFactor: !1, asDate: function (a) {
            ...
            }, noAsDate: !0, asDate: function (a) {
                return a = new Date(this.asNumber(a)), isNaN(a) ? null : a
            }, asNumber: function (a) {
                var b = c, d = this.bad(a, !0);
