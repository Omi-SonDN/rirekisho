!function (a, b) {
    "use strict";
    function c(a, c, d, e) {
        var f, g, h = b.Deferred(), i = b("#wsmediatestcontainer"), j = b("<div />").css({
            width: 320,
            height: 120,
            "float": "left"
            ...
            var c = k.prop("duration"), e = k.prop("currentTime");
            c && c > 5 ? e > 0 && 5 > e ? l() : ("ended" == b.type || e >= c - 1) && (a.decode[d].endJump = !0, l()) : l()
        }, n = function (c) {
            if (clearTimeout(f), c)if ("loadedmetadata" == c.type) {
                if ("swf" == d)try {
                ...
                success: !1
            }; else a.decode[d] = {success: !1, timeout: !0};
            setTimeout(function () {
                k.play()
    ...
    function d(d, e) {
        var f = [], g = d.declaredContainer || d.computedContainer || d.headerContainer || "", h = a.cfg.mediaelement.preferFlash;
    ...
    function f(a, c) {
        ...
        if (f.src.indexOf(m))f.cors = !0; else try {
            f.headerType = "", f.headers = {}, d = b.ajax({
                url: f.src, type: "head", success: function () {
    ...
    function g(a) {
        var c, d = [], e = [], g = b("source", a.element), h = [], i = b.Deferred(), j = 0, k = function () {
            j++, j > 1 && i.resolve()
        };
    ...
    function h(a) {
        b.each(n, function (b, c) {
            ...
            })) : e = c.test(a), e && a.errors.push({message: f, level: c.level, name: b})
    ...
    function i(a) {
        var c = {
            ...
            errors: [],
            poster: {src: b.prop(a, "poster"), attrSrc: b.trim(b.attr(a, "poster")), errors: {}},
    ...
    if (window.console) {
        var j = a.mediaelement, k = swfmini.hasFlashPlayerVersion("10.0.3"), l = a.support.mediaelement, m = location.protocol + "//" + location.hostname, n = {
            urlInValid: {
                level: 1,
                test: function () {
                    var a = /^[a-z0-9\,\.\:\/\-_\;\?#\+\*\!\(\)\$\;\&\=\+]+$/i;
                ...
                level: 3, test: function (a) {
                    return a.ajax && !a.httpError ? !a.headers["Content-Length"] : "not testable"
                }, srcTest: {srces: 1}, message: "Content-Length header for media file does not send value."
            }, noRange: {
                level: 3,
                test: function (a) {
                ...
                level: 1,
                test: function (a, b) {
                    var c, d, e = !1, f = a.declaredContainer || a.computedContainer, g = a.headerContainer;
                ...
                }, srcTest: {srces: 1}, message: "Computed type and declared type are different. Needs manual check."
            }, hasNoPlayableSrc: {
                level: 1,
                test: function (a) {
                    var c = !1;
                    return b.each(a.srces, function (b, d) {
                        var e = d.declaredContainer || d.computedContainer, f = d.headerContainer || e;
                ...
                }, srcTest: {srces: 1}, message: "Could not run decode tests. Maybe moovposition is on end?"
            }, moovPosition: {
                level: 2, test: function (a) {
                ...
                test: function (a) {
                    ...
                    return k || b.each(a.srces, function (b, e) {
                        var f = e.declaredContainer || e.computedContainer, g = e.headerContainer || f;
